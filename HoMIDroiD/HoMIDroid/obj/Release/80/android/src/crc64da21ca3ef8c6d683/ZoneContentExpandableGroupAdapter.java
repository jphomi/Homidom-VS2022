...
public class ZoneContentExpandableGroupAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HoMIDroid.Adapters.ZoneContentExpandableGroupAdapter, HoMIDroid", ZoneContentExpandableGroupAdapter.class, __md_methods);
	}


	public ZoneContentExpandableGroupAdapter ()
	{
		super ();
		if (getClass () == ZoneContentExpandableGroupAdapter.class)
			mono.android.TypeManager.Activate ("HoMIDroid.Adapters.ZoneContentExpandableGroupAdapter, HoMIDroid", "", this, new java.lang.Object[] {  });
	}
