            ...
            Try
                ...
                If (files IsNot Nothing) Then
                    For Each file In files
                        ...
                        Catch ex As Exception
                            Log(TypeLog.ERREUR_CRITIQUE, TypeSource.SERVEUR, "LoadConfig", "Erreur lors du chargement de la configuration du serveur : " & ex.Message)
                        End Try
                            ...
                            If list.Count > 0 Then 'présence d'un composant
                                For j As Integer = 0 To list.Count - 1
                                    ...
                                    With _Dev
                                        ...
                                        Or _Dev.Type = "LAMPE" _                        '    Or _Dev.Type = "LAMPERGBW"' _
                                        ...
                                        If _Dev.Type = "LAMPERGBW" Then
                                            ...
                                            If (Not list.Item(j).Attributes.GetNamedItem("brightness") Is Nothing) Then .brightness = list.Item(j).Attributes.GetNamedItem("brightness").Value
                                            If (Not list.Item(j).Attributes.GetNamedItem("optionnal") Is Nothing) Then .optionnal = list.Item(j).Attributes.GetNamedItem("optionnal").Value
                                        End If
            ...
            Try
                ...
                For i As Integer = 0 To _ListDevices.Count - 1
                    Try
                        ...
                        Or _ListDevices.Item(i).Type = "LAMPE" _                          ' Or _ListDevices.Item(i).Type = "LAMPERGBW"
                        ...
                        If _ListDevices.Item(i).Type = "LAMPERGBW" Then
                            ...
                            writer.WriteEndAttribute()
                            writer.WriteStartAttribute("brightness")
                            writer.WriteValue(_ListDevices.Item(i).brightness)
                            writer.WriteEndAttribute()
...
#Region "Historisation"
        ...
        Public Function DeleteHisto(ByVal idsrv As String, ByVal IdDevice As String, ByVal DateTime As String, ByVal Value As String, ByVal Source As String) As Integer Implements IHoMIDom.DeleteHisto
            Try
                ...
                Else
                    Log(TypeLog.INFO, TypeSource.SERVEUR, "DeleteHisto", "Suppression de relevé : " & IdDevice & " " & DateTime)
                End If
            ...
            Try
                ...
                For Each _dev In _ListDevices
                    Select Case True
                        Case _dev.Purge > 0
                            ...
                            If result IsNot Nothing Then
                                ...
                                For i As Integer = 0 To result.Count - 1
                                    ...
                                    If DateTime = datejour Then Continue For ' evite de retraiter un enreg deja supprimé
                                    Dim info As String = sqlite_homidom.nonquery("DELETE FROM historiques WHERE device_id='" & _dev.ID & "' AND dateheure='" & result.Item(i).DateTime & "' AND source='" & Source & "'")
                                    Log(TypeLog.INFO, TypeSource.SERVEUR, "PurgeHisto", info)
                                    datejour = DateTime
                                    'decrementation du nombre d'histo du composant
                                    '  If _dev IsNot Nothing Then
                                    ' _dev.CountHisto -= 1
                                ...
                                Next
                            End If
                            result = GetHistoDeviceSource(_IdSrv, _dev.ID, Source, DateStart, Now.ToString("yyyy-MM-dd HH:mm:ss"))
                            _dev.CountHisto = result.Count

                        Case _dev.MoyJour > 0 And (_dev.Purge > _dev.MoyJour Or _dev.Purge = 0)
                            result = New List(Of Historisation)
                        ...
                        Case _dev.MoyHeure > 0 And (_dev.MoyJour > _dev.MoyHeure Or _dev.MoyJour = 0) And ((_dev.Purge > _dev.MoyHeure And _dev.Purge > 0) Or _dev.Purge = 0)
                            result = New List(Of Historisation)
                            result1 = New List(Of Historisation)
                            DateTime = ""
                            DateStart = ""
                    ...
                    With x
                        ...
                        Select Case .Type
                            ...
                            Case Device.ListeDevices.LAMPERGBW
                                ...
                                .brightness = _ListDevices.Item(i).brightness
                            ...
                            Case Device.ListeDevices.METEO
                                ...
                                .ConditionJ2 = _ListDevices.Item(i).ConditionJ2
                    ...
                    Select Case UCase(type)
                        ...
                        Case "LAMPERGBW"
                            With MyNewObj
                                ...
                                If Proprietes.ContainsKey("brightness") Then .brightness = Proprietes("brightness") Else .brightness = 0
                    ...
                    For i As Integer = 0 To _ListDevices.Count - 1
                        If _ListDevices.Item(i).ID = deviceId Then
                            ...
                            ElseIf _ListDevices.Item(i).Type = "LAMPERGBW" Then
                                ...
                                If Proprietes.ContainsKey("brightness") Then _ListDevices.Item(i).brightness = Proprietes("brightness") Else _ListDevices.Item(i).brightness = 0
                    ...
                    If _ListDevices.Item(i).ID = DeviceId Then
                        ...
                        Select Case retour.Type
                            ...
                            Case Device.ListeDevices.LAMPERGBW
                                ...
                                retour.brightness = _ListDevices.Item(i).brightness
                ...
                If x IsNot Nothing Then
                    If x.ListElement.Count > 0 Then
                        For i As Integer = 0 To x.ListElement.Count - 1
                            ...
                            'If z IsNot Nothing Then y.Add(z.ID)
