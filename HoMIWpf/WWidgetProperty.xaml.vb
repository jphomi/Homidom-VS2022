    ...
    Public Property Objet As uWidgetEmpty
        ...
        Set(ByVal value As uWidgetEmpty)
            ...
            Try
                ...
                CbStatusPosition.SelectedIndex = Obj.PositionStatus
                ...
                Else
                    Select Case Obj.Type
                        ...
                        Case uWidgetEmpty.TypeOfWidget.Gauge
                            ...
                            End If
                        Case uWidgetEmpty.TypeOfWidget.Chart
                            StkPicture.Visibility = Visibility.Collapsed
                            StkStatus.Visibility = Visibility.Collapsed
                            StkRss.Visibility = Windows.Visibility.Collapsed
                            StkMeteo.Visibility = Windows.Visibility.Collapsed
                            ...
                            End If
                        Case uWidgetEmpty.TypeOfWidget.Thermostat
                            StkPicture.Visibility = Visibility.Collapsed
                            StkStatus.Visibility = Visibility.Collapsed
                            StkRss.Visibility = Windows.Visibility.Collapsed
                            StkMeteo.Visibility = Windows.Visibility.Collapsed
                            ...
                            If IsConnect Then
                                ...
                                Dim idx As Integer = -1
                                For Each _devk As TemplateDevice In AllDevices
                                    If _devk.Type = Device.ListeDevices.GENERIQUEVALUE Or _devk.Type = Device.ListeDevices.TEMPERATURECONSIGNE Then
                                        Dim x As New ComboBoxItem
                                        x.Content = _devk.Name
                                        x.Tag = _devk.ID
                                        CbDeviceKeyPad.Items.Add(x)
            ...
            Catch ex As Exception
                AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur WWidgetProperty.Set Objet: " & ex.Message, "Erreur", " WWidgetProperty.Set Objet")
            End Try
        End Set
    End Property
...
#Region "Button OK Annuler"
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnOk.Click
        Try
            ...
            Obj.PositionStatus = CbStatusPosition.SelectedIndex

            Try
                Obj.TailleStatus = TxtTailleStatus.Text
            Catch ex As Exception
                AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur: " & ex.Message, "Erreur", "Erreur: " & ex.Message)
                Exit Sub
            End Try
            ...
            If CbVilleMeteo.SelectedIndex >= 0 Then
                ...
                Obj.IDMeteo = x.Tag
            End If
            If CbDeviceKeyPad.SelectedIndex >= 0 And Obj.Type = uWidgetEmpty.TypeOfWidget.Moteur Then
                If TxtValueMax.Text = "0" Then Obj.Max = TxtValueMax.Text
            End If
            ...
            If CbDeviceKeyPad.SelectedIndex >= 0 And Obj.Type = uWidgetEmpty.TypeOfWidget.Gauge Then
                ...
                Obj.Id = x.Tag
            End If
           If CbDeviceKeyPad.SelectedIndex >= 0 And Obj.Type = uWidgetEmpty.TypeOfWidget.Chart Then
                Dim x As ComboBoxItem = CbDeviceKeyPad.Items(CbDeviceKeyPad.SelectedIndex)
                Obj.Id = x.Tag
            End If
            If CbDeviceKeyPad.SelectedIndex >= 0 And (Obj.Type = uWidgetEmpty.TypeOfWidget.Volet Or Obj.Type = uWidgetEmpty.TypeOfWidget.Moteur Or Obj.Type = uWidgetEmpty.TypeOfWidget.Prise) Then
                ...
                Obj.Id = x.Tag
            End If
            If CbDeviceKeyPad.SelectedIndex >= 0 And Obj.Type = uWidgetEmpty.TypeOfWidget.Thermostat Then
                Dim x As ComboBoxItem = CbDeviceKeyPad.Items(CbDeviceKeyPad.SelectedIndex)
                Obj.Id = x.Tag
            End If
            If CbDeviceKeyPad.SelectedIndex >= 0 And (Obj.Type = uWidgetEmpty.TypeOfWidget.Volet Or Obj.Type = uWidgetEmpty.TypeOfWidget.Moteur Or Obj.Type = uWidgetEmpty.TypeOfWidget.Prise) Then
...
#End Region
    ...
    Private Sub BtnOkAction_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnOkAction.Click
        Try
            ...
            LblActionValue.Visibility = Windows.Visibility.Collapsed
            TxtValue.Visibility = Windows.Visibility.Collapsed
            TxtStatus.Visibility = Windows.Visibility.Collapsed
            CbActionValue.Visibility = Windows.Visibility.Collapsed
        Catch ex As Exception
    ...
    Private Sub Refresh_LstObjetVisu()
        Try
            ...
            Next
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur Refresh_LstObjetVisu: " & ex.Message, "Erreur", "Refresh_LstObjetVisu")
        End Try
    End Sub
    ...
    Private Sub LstObjetVisu_SelectionChanged(ByVal sender As System.Object, ByVal e As Object) Handles LstObjetVisu.SelectionChanged, LstObjetVisu.MouseLeftButtonDown
        Try
            If LstObjetVisu.SelectedIndex >= 0 Then
                ...
                TxtStatus.Visibility = Windows.Visibility.Visible
            End If
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur LstObjetVisu_SelectionChanged: " & ex.ToString, "Erreur", "LstObjetVisu_SelectionChanged")
        End Try
    ...
    Private Sub BtnOkVisu_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnOkVisu.Click
        Try
            ...
            TxtStatus.Visibility = Windows.Visibility.Collapsed
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur BtnOkVisu_Click: " & ex.Message, "Erreur", "LstObjetVisu_SelectionChanged")
        End Try
    End Sub
    ...
    Private Sub ImgVisu_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Input.MouseButtonEventArgs) Handles ImgVisu.MouseDown, BorderVisu.MouseDown
        Try
            ...
            frm = Nothing
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur WWidgetProperty.ImgVisu_MouseDown: " & ex.Message, "Erreur", "WWidgetProperty.ImgVisu_MouseDown")
        End Try
    End Sub
    ...
    Private Sub BtnImgVisu_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnImgVisu.Click
        Try
            ...
            frm = Nothing
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur WWidgetProperty.ImgVisu_Click: " & ex.Message, "Erreur", "WWidgetProperty.ImgVisu_Click")
        End Try
    End Sub
    ...
    Private Sub ImgPicture_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Input.MouseButtonEventArgs) Handles ImgPicture.MouseDown
        Try
            ...
            frm = Nothing
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur ImgPicture.MouseDown: " & ex.Message, "Erreur", "ImgPicture_MouseDown")
        End Try
    End Sub
    ...
    Private Sub BtnInitPictLocal_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnInitPict_Local.Click
        Try
            ...
            End If
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur ImgPicture.BtnInitPictLocal_Click: " & ex.Message, "Erreur", "ImgPicture.BtnInitPictLocal_Click")
        End Try
    ...
    Private Sub BtnInitPictServeur_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnInitPict_Serveur.Click
        ...
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur ImgPicture.BtnInitPictServeur_Click: " & ex.ToString, "Erreur", "ImgPicture.BtnInitPictServeur_Click")
        End Try
...
#Region "Http"
    ...
    Public Sub Refresh_LstHttpBtn()
        Try
            ...
            Next
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur WWidgetProperty.Refresh_LstHttpBtn: " & ex.Message, "Erreur", "WWidgetProperty.Refresh_LstHttpBtn")
        End Try
    End Sub
    ...
    Private Sub HttpOkBtn_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles HttpOkBtn.Click
        ...
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur HttpOkBtn_Click: " & ex.Message, "Erreur", "HttpOkBtn_Click")
        End Try
    End Sub
    ...
    Private Sub HttpListBtn_SelectionChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.SelectionChangedEventArgs) Handles HttpListBtn.SelectionChanged
        Try
            ...
            End If
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur HttpListBtn_SelectionChanged: " & ex.Message, "Erreur", "HttpListBtn_SelectionChanged")
        End Try
    End Sub
    ...
    Private Sub HttpSearchIcon_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles HttpSearchIcon.Click
        Try
            ...
            frm = Nothing
        Catch ex As Exception
            AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur HttpSearchIcon_Click: " & ex.Message, "Erreur", "HttpSearchIcon_Click")
        End Try
    End Sub
...
#End Region
    ...
    Private Sub TxtValueVisu_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs) Handles TxtValueVisu.TextChanged
        ...
        Try
            ...
            End If
        Catch ex As Exception
            If _flag = False Then AfficheMessageAndLog(FctLog.TypeLog.ERREUR, "Erreur TxtValue_TextChanged: " & ex.Message, "Erreur", "TxtValueVisu_TextChanged")
        End Try
    End Sub
