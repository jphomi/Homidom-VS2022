Public Class cWidget
    ...
    Public Class Visu
        ...
        Sub New(Optional ByVal vIdObject As String = "", Optional ByVal vPropriete As String = "", Optional ByVal vValue As Object = Nothing, Optional ByVal vImage As String = "", Optional vOperateur As Operateur = cWidget.Operateur.Equal, Optional vText As String = "", Optional vStt As String = "")
            _IdObject = vIdObject
