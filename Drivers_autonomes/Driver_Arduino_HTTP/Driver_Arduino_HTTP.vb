...
#Region "Fonctions génériques"
    ...
    Public Sub New()
        Try
            ...
            add_devicecommande("CONFIG_TYPE_PINX", "configurer le type de PIN sur l arduino suivant les propriétés du composant pour tous les composants associé à cet Arduino", 0)
