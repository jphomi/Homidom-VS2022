...
' Auteur : JPHomi
' Date : 19/01/2020  Creation du driver


''' <summary>Class Driver_GoogleMessages, permet d'envoyer/recevoir des sms Google.</summary>
...
#Region "Variables génériques"
    ...
    Dim _ID As String = "A09D9D20-1E9F-11EA-B68C-500E51FCEAB8"
    Dim _Nom As String = "GoogleMessages"
    Dim _Enable As Boolean = False
    Dim _Description As String = "Google Messages"
