...
#Region "Variables internes"
    ...
    Private serverhttp As HttpSelfHostServer
    ...
    Public Sub Start() Implements homidom.HoMIDom.IDriver.Start
        Try
            ...
            If System.IO.File.Exists(fileName) Then
                ...
                ServerKey = _IdSrv
                Dim httpApiUrl As String = "http://" & _Server.GetIPSOAP & ":" & _Server.GetPortSOAP & "/Imperihome/"  '
                Dim config = New HttpSelfHostConfiguration(httpApiUrl)

                config.Routes.MapHttpRoute("DefaultApi", "{key}/{controller}/{id}", New With {
                .id = RouteParameter.[Optional]
                })
                config.Routes.MapHttpRoute("CommandApi", "{key}/{controller}/{id}/action/{command}/{param}", New With {
                .param = RouteParameter.[Optional],
                .action = "ExecuteCommand"
                }) 'DevicesController
                config.Routes.MapHttpRoute("ValueApi", "{key}/{controller}", New With {
                 .action = "GetValue"
                }) 'DevicesController / RoomsController / SystemController
                config.Routes.MapHttpRoute("HistoApi", "{key}/{controller}/{id}/{param}/histo/{startdate}/{enddate}", New With {
                 .action = "GetHisto"
                }) 'DevicesController
                ...
                If System.IO.File.Exists(fileName) Then
                    ...
                    WriteLog("Device chargés : " & _allDevImperi.devices.Count & " à l'adresse " & httpApiUrl)
                End If
            ...
            Else
                _IsConnect = False
                WriteLog("ERR: Start, Configurez les composants que vous souhaitez voir dans ImperiHome, allez dans HoMIAdmin, Configuration, Onglet Configuration, Bouton 'Export Imperihome' ")
            End If
...
Public Class DevicesController
    ...
    Public Function GetValue() As Object
        ...
        Try
            ...
            Driver_ImperiHome.CurrentServer.Log(TypeLog.DEBUG, TypeSource.DRIVER, "Getvalue allDevImperi ", allDevImperiTemp.devices.Count)
    ...
    Private Function ExecuteCommandWithParams(ByVal id As String, ByVal command As String, ByVal param As String) As Object
        ...
        Try
            ...
            fileName = My.Application.Info.DirectoryPath & "\Drivers\Imperihome\action_ret.json"
        ...
        Catch ex As Exception
            Driver_ImperiHome.CurrentServer.Log(TypeLog.ERREUR, TypeSource.DRIVER, "ExecuteCommandWithParams", ex.Message)
            Return False
        End Try
    ...
    Private Function ParamByType(ByVal comp0 As HoMIDom.HoMIDom.TemplateDevice, ByVal dev As Device) As List(Of DeviceParam)
        ...
        Catch ex As Exception
            Driver_ImperiHome.CurrentServer.Log(TypeLog.ERREUR, TypeSource.DRIVER, "ParamByType", dev.name & " " & ex.Message)
            Return Nothing
        End Try
    ...
    Public Function GetValue() As Object
        Try
            ...
            If System.IO.File.Exists(fileName) Then
                ...
                Driver_ImperiHome.CurrentServer.Log(TypeLog.DEBUG, TypeSource.DRIVER, "GetValue allZoneImperi ", allZoneImperi.rooms.Count)
                Return allZoneImperi

            Else
                Return "Le fichier rooms n'existe pas"
            End If
    ...
    Public Function GetValue() As Object
        Try
            ...
            If System.IO.File.Exists(fileName) Then
                ...
                Driver_ImperiHome.CurrentServer.Log(TypeLog.DEBUG, TypeSource.DRIVER, "system2", system2.ToString)
                Return system2
            Else
                Return "Le fichier system n'existe pas"
            End If
