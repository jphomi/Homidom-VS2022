...
#Region "Variables Internes"
        ...
        Enum CommandClass As Byte
            ...
            COMMAND_CLASS_ZIP_SERVICES_V2 = 35                    ' 0x23
            COMMAND_CLASS_ZIP_SERVICES_V3 = 35                    ' 0x23
            COMMAND_CLASS_ZIP_SERVICES_V4 = 35                    ' 0x23
            ...
            COMMAND_CLASS_SENSOR_MULTILEVEL_V8 = 49               ' 0x31
            COMMAND_CLASS_SENSOR_MULTILEVEL_V9 = 49               ' 0x31
            COMMAND_CLASS_SENSOR_MULTILEVEL_V10 = 49              ' 0x31
            COMMAND_CLASS_SENSOR_MULTILEVEL_V11 = 49              ' 0x31
            COMMAND_CLASS_METER = 50                              ' 0x32
            COMMAND_CLASS_METER_V2 = 50                           ' 0x32
            COMMAND_CLASS_METER_V3 = 50                           ' 0x32
            COMMAND_CLASS_METER_V4 = 50                           ' 0x32
            COMMAND_CLASS_METER_V5 = 50                           ' 0x32
            COMMAND_CLASS_METER_V6 = 50                           ' 0x32
            COMMAND_CLASS_COLOR = 51                              ' 0x33
            COMMAND_CLASS_COLOR_V2 = 51                           ' 0x33
            COMMAND_CLASS_COLOR_V3 = 51                           ' 0x33
            COMMAND_CLASS_COLOR_CONTROL = 51                      ' 0x33
            COMMAND_CLASS_COLOR_CONTROL_V2 = 51                   ' 0x33
            COMMAND_CLASS_COLOR_CONTROL_V3 = 51                   ' 0x33
            COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION = 52       ' 0x34
            COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V2 = 52    ' 0x34
            COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V3 = 52    ' 0x34
            ...
            COMMAND_CLASS_METER_TBL_MONITOR_V3 = 61               ' 0x3D
            ...
            COMMAND_CLASS_THERMOSTAT_FAN_MODE_V5 = 68             ' 0x44
            ...
            COMMAND_CLASS_NETWORK_MANAGEMENT_BASIC_V2 = 77        ' 0x4D
            ...
            COMMAND_CLASS_NETWORK_MANAGEMENT_PROXY_V2 = 82        ' 0x52
            COMMAND_CLASS_SCHEDULE = 83                           ' 0x53
            COMMAND_CLASS_SCHEDULE_V2 = 83                        ' 0x53
            COMMAND_CLASS_SCHEDULE_V3 = 83                        ' 0x53
            COMMAND_CLASS_SCHEDULE_V4 = 83                        ' 0x53
            ...
            COMMAND_CLASS_DOOR_LOCK_V4 = 98                       ' 0x62
            COMMAND_CLASS_USER_CODE = 99                          ' 0x63
            COMMAND_CLASS_USER_CODE_V2 = 99                       ' 0x63
            ...
            COMMAND_CLASS_HUMIDITY_CONTROL_MODE_V2 = 109          ' 0x6D
            ...
            COMMAND_CLASS_CONFIGURATION_V4 = 112                  ' 0x70
            ...
            COMMAND_CLASS_NOTIFICATION_V2 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V3 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V4 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V5 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V6 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V7 = 113                   ' 0x71
            COMMAND_CLASS_NOTIFICATION_V8 = 113                   ' 0x71
            ...
            COMMAND_CLASS_SOUND_SWITCH = 120                      ' 0x79
            COMMAND_CLASS_SOUND_SWITCH_V2 = 120                   ' 0x79
            ...
            COMMAND_CLASS_FIRMWARE_UPDATE_MD_V5 = 122             ' 0x7A
            COMMAND_CLASS_FIRMWARE_UPDATE_MD_V6 = 122             ' 0x7A
            COMMAND_CLASS_FIRMWARE_UPDATE_MD_V7 = 122             ' 0x7A
            ...
            COMMAND_CLASS_TIME_PARAMETERS_V2 = 139                ' 0x8B
            ...
            COMMAND_CLASS_MULTI_CHANNEL_ASSOCIATION_V4 = 142      ' 0x8E
            ...
            COMMAND_CLASS_SIMPLE_AV_CONTROL_V2 = 148              ' 0x94
            COMMAND_CLASS_SIMPLE_AV_CONTROL_V3 = 148              ' 0x94
            COMMAND_CLASS_SIMPLE_AV_CONTROL_V4 = 148              ' 0x94
            ...
            COMMAND_CLASS_SECURITY_2 = 159                        ' 0x9F
            COMMAND_CLASS_IR_REPEATER = 160                       ' 0xA0
            COMMAND_CLASS_AUTHENTICATION = 161                    ' 0xA1
            COMMAND_CLASS_AUTHENTICATION_MEDIA_WRITE = 162        ' 0xA2
            COMMAND_CLASS_GENERIC_SCHEDULE = 163                  ' 0xA3
            ...
            Try
                If _Com <> "" Then
                    ...
                    While (m_nodesReady = False And CptBoucle < 10)
                        System.Threading.Thread.Sleep(1000) ' Attente de 3 sec  - Info OpenZWave Wait since this process can take around 20seconds within some network
                        ...
                        Case (Objet.Type = "LAMPE" Or Objet.Type = "LAMPERGBW" Or Objet.Type = "APPAREIL" Or Objet.Type = "SWITCH" Or Objet.Type = "VOLET")
                            ...
                            Select Case True
                                Case UCase(Commande) = "ON"
                                    If IsMultiLevel Then
                                        If InStr(Objet.Adresse2, "Level:") > 0 Then
                                            Dim OnValue As Byte = 99 'Objet.ValueMax - 1   ' n'accepte que 99 max
                                ...
                                Case UCase(Commande) = "OFF"
                                    If IsMultiLevel Then
                                        If InStr(Objet.Adresse2, "Level:") > 0 Then
                                            Dim OffValue As Byte = 0 'Objet.ValueMin
                                            m_manager.SetValue(ValueTemp, OffValue)
                                            Objet.Value = OffValue
                                        Else
                                            If NodeTemp.CommandClass.Contains(CommandClass.COMMAND_CLASS_SWITCH_MULTILEVEL) Or
                                                NodeTemp.CommandClass.Contains(CommandClass.COMMAND_CLASS_SWITCH_MULTILEVEL_V2) Or
                                                NodeTemp.CommandClass.Contains(CommandClass.COMMAND_CLASS_SWITCH_MULTILEVEL_V3) Or
                                    ...
                                    If Not IsNothing(Parametre1) Then
                                        ...
                                        Select Case True
                                            Case InStr(Objet.adresse2, "Color:") > 0
                                                If Len(Parametre1) > 4 Then  'cas du code hexa
                                                    If InStr(Parametre1, "#") > 0 Then
                                                        m_manager.SetValue(ValueTemp, Parametre1)
                                                    Else
                                                        m_manager.SetValue(ValueTemp, "#" & Parametre1) 'cas de l'hexadecimal avec blanc
                                                    End If
                                                Else
                                                    Dim HexR, HexB, HexG, HexW As String
                                                    ...
                                                    If UCase(Commande) = "WHITE" Then
                                                        HexW = Hex(ValDimmer)
                                                    Else
                                                        HexW = Hex(Objet.white)
                                                    End If
                                                    If Len(HexW) < 2 Then HexW = "0" & HexW

                                                    Dim color_str As String = "#" & HexR & HexG & HexB & HexW
...
#Region "Fonctions internes"
        ...
        Private Function ouvrir(ByVal numero As String) As String
            Try
                ...
                ' Dim mycommand As New SQLiteCommand(SQLconnect)
                ' Dim txt = mycommand.ExecuteNonQuery()
                    ...
                    If NumNode > 1 Then
                        For i = 0 To m_nodeList.Count - 1
                            ...
                            If NumNode = node.ID Then
                                Trouve = True
                                WriteLog("ReplaceFailedNode sur Noeud -> " & m_nodeList.ElementAt(NumNode).ID & " : " & m_nodeList.ElementAt(NumNode).Product)
            ...
            Try
                ...
                Select Case m_notification.[GetType]()
                    ...
                    Case ZWNotification.Type.NodeNew
                        ' Un nouveau nœud a été trouvé (non stocké dans le fichier zwcfg*.xml) 
                        WriteLog("NotificationHandler - Nouveau noeud trouvé" & m_notification.GetNodeId())
                    ...
                    If (m_newDevice Is Nothing) Then
                        ...
                        Select Case m_device.Adresse2.ToLower().Trim()
                            ...
                            Case "Dry Air".ToLower()
                                m_device.Type = ListeDevices.TEMPERATURECONSIGNE.ToString()
                            Case "Color".ToLower()
                                m_device.Type = ListeDevices.LAMPERGBW.ToString()
                        End Select
                        ...
                        If (IsNothing(LocalDevice.adresse2) Or (LocalDevice.adresse2 = m_valueLabel) Or (LocalDevice.adresse2 = m_valueLabel & ":" & m_instance) Or (LocalDevice.adresse2 = m_valueLabel & ":" & m_instance & "." & m_index)) Then
                            ...
                            If (DateTime.Now - Date.Parse(LocalDevice.LastChange)).TotalMilliseconds > 1500 Then
                                ...
                                ' Traitement particulier pour les temperatures
                                    Case UCase(LocalDevice.type) = "TEMPERATURE" Or UCase(LocalDevice.type) = "TEMPERATURECONSIGNE"
                                    ...
                                    Case UCase(m_valueLabel) = "BATTERY LEVEL"
                                        If m_valueString <= 5 Then
                                            WriteLog("ERR: " & LocalDevice.nom & " : Batterie vide")
                                        End If

                                    Case UCase(m_valueLabel) = "COLOR"
                                        ...
                                        LocalDevice.red = Val("&H" & Mid(ValeurRecue, 1, 2))
                                        LocalDevice.green = Val("&H" & Mid(ValeurRecue, 3, 2))
                                        LocalDevice.blue = Val("&H" & Mid(ValeurRecue, 5, 2))
                                        LocalDevice.white = Val("&H00")  'valeur par defaut
                                        If Len(ValeurRecue) > 6 Then
                                            LocalDevice.white = Val("&H" & Mid(ValeurRecue, 7, 2))
                                        End If
                            ...
                            Else
                                WriteLog("DBG: " & "Reception < 1.5s de deux valeurs pour le meme composant : " & m_nodeId & ":" & m_instance & " -> " & m_valueLabel & "=" & ValeurRecue)
                            End If
                        End If
                    Next
                Else
