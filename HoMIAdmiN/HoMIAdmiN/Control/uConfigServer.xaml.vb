        ...
        Try
            If IsConnect = True Then
                ...
                If Not IsNumeric(TxtAnimationTime.Text) Then
                    Settings.Default.AnimationDuration = 300
                Else
                    If TxtAnimationTime.Text < 0 Then TxtAnimationTime.Text = 0
                    If TxtAnimationTime.Text > 1000 Then TxtAnimationTime.Text = 1000
                    Settings.Default.AnimationDuration = TxtAnimationTime.Text
                End If

                Settings.Default.SaveRealTime = ChKSaveRealTime.IsChecked
    ...
    Public Sub New()
        ...
        Try
            ...
            If IsConnect = True Then
                ...
                ChKSaveRealTime.IsChecked = Settings.Default.SaveRealTime

                If Not IsNumeric(Settings.Default.AnimationDuration) Then
                    TxtAnimationTime.Text = 300
                Else
                    TxtAnimationTime.Text = Settings.Default.AnimationDuration
                End If
