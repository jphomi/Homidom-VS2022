...
Partial Public Class uDevice
            ...
            Else 'Modification d'un Device
                ...
                If x IsNot Nothing Then 'on a trouvé le device
                    ...
                    If x.Type = ListeDevices.LAMPERGBW Then
                        ...
                        TxtRGBWbrightness.Text = x.brightness
        ...
        Try
            If _Action = EAction.Nouveau Then
                ...
                If CbType.Text = "BAROMETRE" _
                    ...
                    Or CbType.Text = "LAMPE" _ '                    Or CbType.Text = "LAMPERGBW" _
                    ...
                    If CbType.Text = "HUMIDITE" Or CbType.Text = "LAMPE" Or CbType.Text = "VOLET" Then  'Or CbType.Text = "LAMPERGBW"
                        TxtValueMin.Text = "0"
    ...
    Private Sub TxtValueMin_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs) Handles TxtValueMin.TextChanged
        Try
            Dim i As Integer
            If (String.IsNullOrEmpty(TxtValueMin.Text)) Or (String.IsNullOrEmpty(TxtValueMin.Text) = False And i.TryParse(TxtValueMin.Text, i) = False) Then
                AfficheMessageAndLog(HoMIDom.HoMIDom.Server.TypeLog.ERREUR, "Veuillez saisir une valeur numérique")
                TxtValueMin.Text = -99
            End If
        Catch ex As Exception
            AfficheMessageAndLog(HoMIDom.HoMIDom.Server.TypeLog.ERREUR, "Erreur uDevice TxtValueMin_TextChanged: " & ex.ToString, "ERREUR", "TxtValueMin_TextChanged")
        End Try
    End Sub
    Private Sub TxtValueMax_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs) Handles TxtValueMax.TextChanged
        Try
            Dim i As Integer
            If (String.IsNullOrEmpty(TxtValueMax.Text)) Or (String.IsNullOrEmpty(TxtValueMax.Text) = False And i.TryParse(TxtValueMax.Text, i) = False) Then
                AfficheMessageAndLog(HoMIDom.HoMIDom.Server.TypeLog.ERREUR, "Veuillez saisir une valeur numérique")
                TxtValueMax.Text = 9999
            End If
        Catch ex As Exception
    ...
    Private Sub TxtAdresse1_TextChanged(sender As System.Object, e As System.Windows.Controls.TextChangedEventArgs) Handles TxtAdresse1.TextChanged
        Try
            ...
            If CbAdresse1.Items.Count > 0 Then
                If TxtAdresse1.Text.Trim.Length >= 4 Then 'jps = 4 aulieu 8 on cherche dans la liste quand on a tapait l'ID complet
    ...
    Private Sub TxtAdresse2_TextChanged(sender As System.Object, e As System.Windows.Controls.TextChangedEventArgs) Handles TxtAdresse2.TextChanged
        Try
            If CbAdresse2.Items.Count > 0 Then
                If TxtAdresse2.Text.Trim.Length >= 4 Then 'jps = 4 aulieu 8 on cherche dans la liste quand on a tapait l'ID complet
                    Dim flagTrouv As Boolean = False
                    Dim idx As Integer = 0
...
#End Region
    ...
    Function SaveDevice() As Boolean
        Try
            ...
            Select Case False
                Case IsNumeric(TxtRefresh.Text)
                    TxtRefresh.Text = 0
                Case IsNumeric(TxtPrecision.Text)
                    TxtPrecision.Text = 0
                Case TxtCorrection.Text <> ""
                    TxtCorrection.Text = 0
                Case IsNumeric(TxtValDef.Text)
                    TxtValDef.Text = 0
                Case IsNumeric(TxtValueMax.Text)
                    TxtValueMax.Text = 9999
                Case IsNumeric(TxtValueMin.Text)
                    TxtValueMin.Text = -99
            End Select
            ...
            If CbType.Text = "LAMPERGBW" Then
                ...
                If IsNumeric(TxtRGBWspeed.Text) = False Or (TxtRGBWspeed.Text < 0 Or TxtRGBWspeed.Text > 100) Then
                    ...
                    Return False
                End If
                If IsNumeric(TxtRGBWbrightness.Text) = False Or (TxtRGBWbrightness.Text < 0 Or TxtRGBWbrightness.Text > 100) Then
                    AfficheMessageAndLog(HoMIDom.HoMIDom.Server.TypeLog.ERREUR, "Le champ RGBW Brightness doit être un Nombre compris entre 0 et 100", "Erreur", "SaveDevice")
                    Return False
                End If
                ...
                Proprietes.Add("brightness", TxtRGBWbrightness.Text)
