...
#Region "Fonctions de base"
    ...
    Public Sub New()
        Try
            ...
            Me.Window1.WindowState = Settings.Default.WindowState
            If Me.Window1.WindowState = Windows.WindowState.Normal Then
                Me.Window1.Top = Settings.Default.Top
                Me.Window1.Left = Settings.Default.Left
                Me.Window1.Width = Settings.Default.Width
                Me.Window1.Height = Settings.Default.Height
            End If
    ...
    Public Function Connect_Srv(ByVal Name As String, ByVal IP As String, ByVal Port As String) As Integer
        Try
            ...
            Else
                ...
                Settings.Default.SaveRealTime = myService.GetSaveRealTime
    ...
    Private Sub Window1_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Closing
        Try
            If IsConnect = True And FlagChange Then
                ...
                FlagChange = False
            End If
            Settings.Default.WindowState = Me.Window1.WindowState
            If Me.Window1.WindowState = Windows.WindowState.Normal Then
                Settings.Default.Top = Me.Window1.Top
                Settings.Default.Left = Me.Window1.Left
                Settings.Default.Width = Me.Window1.Width
                Settings.Default.Height = Me.Window1.Height
            End If
            Settings.Default.Save()
        ...
        Try
            If CanvasRight.Children.Count > 0 And Objet IsNot Nothing Then
                ...
                For i As Integer = 0 To CanvasRight.Children.Count - 1
                    If Settings.Default.AnimationDuration > 0 Then
                        Dim myDoubleAnimation As DoubleAnimation = New DoubleAnimation()
                        myDoubleAnimation.From = 1.0
                        myDoubleAnimation.To = 0.0
                        myDoubleAnimation.Duration = New Duration(TimeSpan.FromMilliseconds(Settings.Default.AnimationDuration))
