...
<Serializable()> Public Class web
    ...
    Dim _redirect_uris As List(Of String) = New List(Of String)
    Dim _client_id As String = ""
    Dim _token_uri As String = ""
    ...
    ''' <summary>
    ''' token_uri pour ce client
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property token_uri As String
        Get
            Return _token_uri
        End Get
        Set(ByVal value As String)
